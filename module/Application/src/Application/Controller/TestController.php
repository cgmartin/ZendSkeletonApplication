...
class TestController extends AbstractActionController
{
    ...
    {
        $form = new Form\EmailForm('my-form');
        $form
            ->prepareElements()
            ->setAttributes(array(
    ...
    {
        $form = new Form\ColorForm('my-form');
        $form
            ->prepareElements()
            ->setAttributes(array(
                'action' => $this->url()->fromRoute(
    ...
    {
        $form = new Form\MultiCheckboxForm('my-form');
        $form
            ->prepareElements()
            ->setAttributes(array(
                'action' => $this->url()->fromRoute(
    ...
    {
        $form = new Form\DateForm('my-form');
        $form
            ->prepareElements()
            ->setAttributes(array(
                'action' => $this->url()->fromRoute(
    ...
    {
        $form = new Form\Zf2358Form('my-form');
        $form
            ->prepareElements()
            ->setAttributes(array(
                'action' => $this->url()->fromRoute(
    ...
    {
        $form = new Form\NumberForm('my-form');
        $form
            ->prepareElements()
            ->setAttributes(array(
                'action' => $this->url()->fromRoute(
    ...
    public function formMessagesAction()
    {
        $form = new Form\MessagesTestForm('my-form');
        $form
            ->prepareElements()
            ->setAttributes(array(
                'action' => $this->url()->fromRoute(
                    'application/default',
                    array('controller' => 'test', 'action' => 'form-messages'
                )),
            ));
